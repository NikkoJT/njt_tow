...
if (_state) then {
	...
	_towedVehicle setVariable ["tow_isTowReady",true,true];
	...
	if (_towedVehicle getVariable ["tow_lockOverride",false]) then {
	...
	_towedVehicle setVariable ["tow_isTowReady",false,true];
};